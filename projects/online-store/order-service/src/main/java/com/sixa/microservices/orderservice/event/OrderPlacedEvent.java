...
public class OrderPlacedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1911681129365174941L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderPlacedEvent\",\"namespace\":\"com.sixa.microservices.orderservice.event\",\"fields\":[{\"name\":\"orderNumber\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"}]}");
   ...
   */
  public static com.sixa.microservices.orderservice.event.OrderPlacedEvent.Builder newBuilder() {
    return new com.sixa.microservices.orderservice.event.OrderPlacedEvent.Builder();
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.sixa.microservices.orderservice.event.OrderPlacedEvent.Builder newBuilder(com.sixa.microservices.orderservice.event.OrderPlacedEvent.Builder other) {
    if (other == null) {
      return new com.sixa.microservices.orderservice.event.OrderPlacedEvent.Builder();
    } else {
      return new com.sixa.microservices.orderservice.event.OrderPlacedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.sixa.microservices.orderservice.event.OrderPlacedEvent.Builder newBuilder(com.sixa.microservices.orderservice.event.OrderPlacedEvent other) {
    if (other == null) {
      return new com.sixa.microservices.orderservice.event.OrderPlacedEvent.Builder();
    } else {
      return new com.sixa.microservices.orderservice.event.OrderPlacedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlacedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.sixa.microservices.orderservice.event.OrderPlacedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.sixa.microservices.orderservice.event.OrderPlacedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderNumber)) {
        this.orderNumber = data().deepCopy(fields()[0].schema(), other.orderNumber);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sixa.microservices.orderservice.event.OrderPlacedEvent.Builder setOrderNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sixa.microservices.orderservice.event.OrderPlacedEvent.Builder clearOrderNumber() {
      orderNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sixa.microservices.orderservice.event.OrderPlacedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sixa.microservices.orderservice.event.OrderPlacedEvent.Builder clearEmail() {
      email = null;
